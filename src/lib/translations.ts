...
export const translations = {
  ru: {
    ...
    // Consent (152-FZ)
    dsgvoConsent:
      'Даю согласие на обработку персональных данных консультантом для подготовки консультации. Согласен(на), что консультант свяжется со мной после проверки указанных контактных данных.',
  ...
  en: {
    ...
    // Consent (152-FZ)
    dsgvoConsent:
      'I consent to the processing of my personal data by the consultant to prepare my consultation. I agree that the consultant may contact me after verifying the contact details I provided.',
